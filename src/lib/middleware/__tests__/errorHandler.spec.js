...
describe('errorHandler()', () => {
  ...
  it('returns a 500 "Internal server error" for unknown errors', () => {
  ...
  it('returns a 400 error for ValidationErrors', () => {
  ...
  it('returns a 413 error for LimitErrors', () => {
  ...
  it('returns a 401 error for UnauthenticatedErrors', () => {
